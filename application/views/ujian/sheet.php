...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <!-- <h3 class="box-title"><span class="badge bg-green">Jenis :<span id="jenis"></span> </span></h3> -->
                <div class="box-tools pull-right">
                    
                    <?php if( $soal->review != 'Y' ) : ?>
                        <span class="badge bg-red">Sisa Waktu <span class="sisawaktu" data-time="<?=$soal->tgl_selesai?>"></span></span>
                    <?php else : ?>
                        <span class="badge bg-blue">Mode Peninjauan <span class=""></span></span>
                    <?php endif; ?>
    ...
    <div class="col-sm-12">
        ...
        <?php if( $soal->review == 'Y' ) : ?>
            <a href="<?=base_url('ujian/list')?>" class="btn btn-flat btn-sm bg-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
        <?php endif; ?>
    </div>
</div>
