<?=form_open_multipart('dokumen/save', array('id'=>'formdokumen'), array('method'=>'add'));?>
<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <label for="file_dokumen" class="control-label">File Dokumen</label>
                    <div class="form-group">
...
<script src="<?=base_url()?>assets/dist/js/app/master/dokumen/add.js"></script>