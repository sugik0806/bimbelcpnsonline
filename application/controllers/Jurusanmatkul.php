...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Paket Mata Bimbingan',
			'subjudul'=> 'Data Paket Mata Bimbingan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Paket Mata Bimbingan',
			'subjudul'	=> 'Tambah Data Paket Mata Bimbingan',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Paket Mata Bimbingan',
			'subjudul'		=> 'Edit Data Paket Mata Bimbingan',
