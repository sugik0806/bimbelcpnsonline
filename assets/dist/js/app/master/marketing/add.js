...
$(document).ready(function () {
    ...
    $('form#marketing input').on('change', function () {
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input autocomplete="off" type="text" name="nama_marketing[${i}]" class="input-sm form-control">
                        <small class="help-block text-right"></small>
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input autocomplete="off" type="text" name="referal[${i}]" class="input-sm form-control">
                        <small class="help-block text-right"></small>
                    </div>
                </td>
                <td>
