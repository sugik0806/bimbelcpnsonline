        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom Mata Bimbingan kosong, berikut ini kemungkinan penyebabnya :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data Mata Bimbingan (Master Mata Bimbingan kosong/belum ada data sama sekali).</li>
                        <li>Mata Bimbingan sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data Bimbingan Mata Bimbingan nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
