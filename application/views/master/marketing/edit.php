            ...
            <div class="col-sm-offset-3 col-sm-6 col-lg-offset-4 col-lg-4">
                <div class="my-2">
                    <div class="form-horizontal form-inline">
                        ...
                        <div class="pull-right">
                            <span> Jumlah : </span><label for=""><?=count($marketing)?></label>
                        </div>
                    </div>
                </div>
                <?=form_open('marketing/save', array('id'=>'marketing'), array('mode'=>'edit'))?>
                <table id="form-table" class="table text-center table-condensed">
                    ...
                    <tbody>
                        <?php 
                        $no = 1;
                        foreach ($marketing as $j) : ?>
                        <tr>
                            <td><?=$no?></td>
                            <td>
                                <div class="form-group">
                                    <?=form_hidden('id_marketing['.$no.']', $j->id_marketing)?>
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$j->nama_marketing?>" type="text" name="nama_marketing[<?=$no?>]" class="input-sm form-control">
...
<script src="<?=base_url()?>assets/dist/js/app/master/marketing/edit.js"></script>