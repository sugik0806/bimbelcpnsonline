        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="alert bg-purple">
                  <h4>Mata Bimbingan <i class="fa fa-book pull-right"></i></h4>
                    ...
                    <select id="matkul_id" name="matkul_id" class="form-control select2" style="width:100% !important">
                        <option value="" disabled selected>Pilih Mata Bimbingan</option>
                        <?php $sdm = $ujian->id_matkul;
                            foreach ($matkul as $m) :?>
                                <option <?=$sdm===$m->id_matkul?"selected":"";?> value="<?=$m->id_matkul?>"><?=$m->nama_matkul?>
                                </option>
                        <?php endforeach; ?>
                    </select>


                    <small class="help-block bg-warning"></small>
                </div>
                <div class="alert bg-purple">
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <input value="<?=$ujian->waktu?>" placeholder="menit" type="number" class="form-control" name="waktu" id="waktu">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="terbit_id">Status Terbit</label>
                    <select name="terbit_id" class="form-control">
                        <option value="" disabled selected>--- Pilih ---</option>
                        <option <?=$ujian->terbit==="0"?"selected":"";?> value="0">Draft</option>
                        <option <?=$ujian->terbit==="1"?"selected":"";?> value="1">Terbit</option>
                    </select>
                    <small class="help-block"></small>
                </div>
