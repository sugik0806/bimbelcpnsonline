...
class HasilUjian extends CI_Controller {
	...
	public function data()
	{
		...
		if( $this->ion_auth->in_group('mahasiswa') ) {
			$datauser = $this->ujian->getIdMahasiswa($this->user->username);
			$this->output_json($this->ujian->getHasilUjianMhs($datauser->id_mahasiswa), false);
		...
		if($this->ion_auth->is_admin()){
			$nip_dosen = $this->user->username;
			$this->output_json($this->ujian->getHasilUjianAdm(), false);
		}
