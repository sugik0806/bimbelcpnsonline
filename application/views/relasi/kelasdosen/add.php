        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom Pembimbing kosong, berikut ini kemungkinan penyebabnya :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data Pembimbing (Master Pembimbing kosong/belum ada data sama sekali).</li>
                        <li>Dosen sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data kelas Pembimbing nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
