...
class Matkul extends CI_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'judul'	=> 'Mata Bimbingan',
			'subjudul' => 'Data Mata Bimbingan'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Mata Bimbingan',
			'subjudul'	=> 'Tambah Data Mata Bimbingan',
	...
	public function edit()
	{
		...
		if (!$chk) {
			...
			$data = [
				'user' 		=> $this->ion_auth->user()->row(),
				'judul'		=> 'Edit Mata Bimbingan',
				'subjudul'	=> 'Edit Data Mata Bimbingan',
				'matkul'	=> $matkul
			];
			$this->load->view('_templates/dashboard/_header.php', $data);
	...
	public function import($import_data = null)
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> 'Mata Bimbingan',
			'subjudul' => 'Import Mata Bimbingan'
		];
