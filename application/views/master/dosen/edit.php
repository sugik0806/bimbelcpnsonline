    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    <label for="nama_dosen">Nama Pembimbing</label>
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama Pembimbing">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email Pembimbing</label>
                    <input value="<?=$data->email?>" type="text" class="form-control" name="email" placeholder="Email Pembimbing">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
