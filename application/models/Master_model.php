...
class Master_model extends CI_Model {
    ...
    {
        $this->datatables->select('a.id_mahasiswa, a.nama, a.whatsapp, a.email, b.nama_kelas, c.nama_jurusan');
    ...
    {
        $this->db->select('
            (SELECT COUNT(id_mahasiswa) from mahasiswa WHERE id_matkul = 1) AS total_skb, 
            (SELECT COUNT(id_mahasiswa) from mahasiswa WHERE id_matkul = 2) AS total_skd');
    ...
    public function getAllDosenGlobal()
    {
        $this->db->select('*');
