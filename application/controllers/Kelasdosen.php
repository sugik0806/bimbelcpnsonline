...
class KelasDosen extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Kelas Pembimbing',
			'subjudul'=> 'Data Kelas Pembimbing'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Kelas Pembimbing',
			'subjudul'	=> 'Tambah Data Kelas Pembimbing',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Kelas Pembimbing',
			'subjudul'		=> 'Edit Data Kelas Pembimbing',
